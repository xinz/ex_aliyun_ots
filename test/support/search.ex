  ...
  defp insert_test_data(instance_key, table) do
    data = [
      %{
        ...
        score: 99.71,
        is_actived: true,
        tags: Jason.encode!(["1", "2", "3"]),
        place: 10,
        values: Jason.encode!([1, 2, 3])
      },
      %{
        id: "a2",
        class: "class1",
        ...
        score: 100,
        is_actived: false,
        tags: Jason.encode!(["2", "3"]),
        values: Jason.encode!([4, 5, 10])
      },
      %{
        id: "a3",
        class: "class2",
        ...
        score: 66.78,
        is_actived: true,
        tags: Jason.encode!(["4", "1"]),
        place: 4,
        values: Jason.encode!([-3, 6, 8])
      },
      %{
        id: "a4",
        class: "class3",
